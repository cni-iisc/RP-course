...
{{< video https://www.youtube.com/watch?v=foxFoBScCp8&list=PLNN9TCnjABcY562vG5XuSfodGs6_BMcAF >}}
...
::: defn
**Definition 1** (\iid process). A random process $X: \Omega \to \sX^T$ is an **independent and identically distributed** () random process with the common distribution $F:\R \to [0,1]$, if for any finite $S \subseteq T$ and a real vector $x_S \in \R^S$ we can write the finite dimensional distribution for this process as
:::
